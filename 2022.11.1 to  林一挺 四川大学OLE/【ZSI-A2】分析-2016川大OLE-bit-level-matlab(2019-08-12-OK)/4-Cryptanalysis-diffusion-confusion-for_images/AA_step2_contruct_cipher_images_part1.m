...
CC2=Func_BitPlane_Composition(CC2_1,CC1_2,height,width);
CC3=Func_BitPlane_Composition(CC3_1,CC1_2,height,width);
CC4=Func_BitPlane_Composition(CC4_1,CC1_2,height,width);
CC5=Func_BitPlane_Composition(CC5_1,CC1_2,height,width);
CC6=Func_BitPlane_Composition(CC6_1,CC1_2,height,width);
CC7=Func_BitPlane_Composition(CC7_1,CC1_2,height,width);
CC8=Func_BitPlane_Composition(CC8_1,CC1_2,height,width);
CC9=Func_BitPlane_Composition(CC9_1,CC1_2,height,width);

CC10=Func_BitPlane_Composition(CC10_1,CC1_2,height,width);
CC11=Func_BitPlane_Composition(CC11_1,CC1_2,height,width);
CC12=Func_BitPlane_Composition(CC12_1,CC1_2,height,width);
CC13=Func_BitPlane_Composition(CC13_1,CC1_2,height,width);
CC14=Func_BitPlane_Composition(CC14_1,CC1_2,height,width);
CC15=Func_BitPlane_Composition(CC15_1,CC1_2,height,width);
CC16=Func_BitPlane_Composition(CC16_1,CC1_2,height,width);
CC17=Func_BitPlane_Composition(CC17_1,CC1_2,height,width);
CC18=Func_BitPlane_Composition(CC18_1,CC1_2,height,width);
...
imwrite(uint8(CC1),'./images/CC1a.png');  %注意，写入时要采用uint8类型，否则读取时出错
imwrite(uint8(CC2),'./images/CC2a.png'); 
imwrite(uint8(CC3),'./images/CC3a.png'); 
imwrite(uint8(CC4),'./images/CC4a.png'); 
imwrite(uint8(CC5),'./images/CC5a.png'); 
imwrite(uint8(CC6),'./images/CC6a.png'); 
imwrite(uint8(CC7),'./images/CC7a.png'); 
imwrite(uint8(CC8),'./images/CC8a.png'); 
imwrite(uint8(CC9),'./images/CC9a.png'); 
imwrite(uint8(CC10),'./images/CC10a.png'); 
imwrite(uint8(CC11),'./images/CC11a.png'); 
imwrite(uint8(CC12),'./images/CC12a.png'); 
imwrite(uint8(CC13),'./images/CC13a.png'); 
imwrite(uint8(CC14),'./images/CC14a.png'); 
imwrite(uint8(CC15),'./images/CC15a.png'); 
imwrite(uint8(CC16),'./images/CC16a.png'); 
imwrite(uint8(CC17),'./images/CC17a.png'); 
imwrite(uint8(CC18),'./images/CC18a.png');
...
imwrite(uint8(CP1),'./images/CP1a.png');  %注意，写入时要采用uint8类型，否则读取时出错
imwrite(uint8(CP2),'./images/CP2a.png'); 
imwrite(uint8(CP3),'./images/CP3a.png'); 
imwrite(uint8(CP4),'./images/CP4a.png'); 
imwrite(uint8(CP5),'./images/CP5a.png'); 
imwrite(uint8(CP6),'./images/CP6a.png'); 
imwrite(uint8(CP7),'./images/CP7a.png'); 
imwrite(uint8(CP8),'./images/CP8a.png'); 
imwrite(uint8(CP9),'./images/CP9a.png'); 
imwrite(uint8(CP10),'./images/CP10a.png'); 
imwrite(uint8(CP11),'./images/CP11a.png'); 
imwrite(uint8(CP12),'./images/CP12a.png'); 
imwrite(uint8(CP13),'./images/CP13a.png'); 
imwrite(uint8(CP14),'./images/CP14a.png'); 
imwrite(uint8(CP15),'./images/CP15a.png'); 
imwrite(uint8(CP16),'./images/CP16a.png'); 
imwrite(uint8(CP17),'./images/CP17a.png'); 
imwrite(uint8(CP18),'./images/CP18a.png');
